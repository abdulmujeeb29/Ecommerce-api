...
urlpatterns = [
    ...
    path('api/products/<int:pk>/reviews/', views.ProductReviewsList.as_view(), name='product-reviews-list'),
    path('api/products/<int:pk>/reviews/create/', views.ProductReviewCreate.as_view(), name='product-review-create'),
